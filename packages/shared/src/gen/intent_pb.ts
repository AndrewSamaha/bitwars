...
export const file_intent: GenFile = /*@__PURE__*/
  fileDesc("", [file_delta, file_vec2]);
 ...
 *
 * @generated from message bitwars.ResearchIntent
 */
export type ResearchIntent = Message<"bitwars.ResearchIntent"> & {
  /**
   * @generated from field: uint64 entity_id = 1;
   */
  entityId: bigint;
  ...
  /**
   * @generated from field: string technology_id = 2;
   */
  technologyId: string;
};

/**
 * Describes the message bitwars.ResearchIntent.
 * Use `create(ResearchIntentSchema)` to create a new message.
 */
export const ResearchIntentSchema: GenMessage<ResearchIntent> = /*@__PURE__*/
 ...
 *
 * @generated from message bitwars.RepairIntent
 */
export type RepairIntent = Message<"bitwars.RepairIntent"> & {
  /**
   * repairing entity
   *
   * @generated from field: uint64 entity_id = 1;
...
/**
 * Describes the message bitwars.RepairIntent.
...
export type IntentEnvelope = Message<"bitwars.IntentEnvelope"> & {
  ...
  payload: {
    ...
    /**
     * @generated from field: bitwars.RepairIntent repair = 14;
     */
    value: RepairIntent;
    case: "repair";
  } | {
    ...
    /**
     * @generated from field: bitwars.ResearchIntent research = 17;
     */
...
export type Intent = Message<"bitwars.Intent"> & {
  ...
  kind: {
    ...
    /**
     * @generated from field: bitwars.RepairIntent repair = 5;
     */
    value: RepairIntent;
    case: "repair";
  } | {
    ...
    /**
     * @generated from field: bitwars.ResearchIntent research = 7;
     */
    value: ResearchIntent;
    case: "research";
  } | { case: undefined; value?: undefined };
 ...
 */
export type ResearchState = Message<"bitwars.ResearchState"> & {
  /**
   * @generated from field: string technology_id = 1;
   */
  technologyId: string;
...
/**
 * Describes the message bitwars.ResearchState.
 ...
 */
export type RepairState = Message<"bitwars.RepairState"> & {
  /**
   * @generated from field: uint64 target_id = 1;
   */
  targetId: bigint;
...
/**
 * Describes the message bitwars.RepairState.
...
export type ActionState = Message<"bitwars.ActionState"> & {
  ...
  exec: {
    ...
    /**
     * @generated from field: bitwars.RepairState repair = 6;
     */
    value: RepairState;
    case: "repair";
  } | {
    ...
    /**
     * @generated from field: bitwars.ResearchState research = 8;
     */
    value: ResearchState;
    case: "research";
  } | { case: undefined; value?: undefined };
