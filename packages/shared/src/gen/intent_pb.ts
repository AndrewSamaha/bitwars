...
export type CollectIntent = Message<"bitwars.CollectIntent"> & {
   ...
   *
   * @generated from field: string resource_type_id = 4;
   */
   ...
   *
   * @generated from field: bool nearest_compatible = 5;
   */
...
export type CollectState = Message<"bitwars.CollectState"> & {
  ...
  /**
   * @generated from field: string resource_type_id = 2;
   */
  resourceTypeId: string;

  /**
   * @generated from field: bool nearest_compatible = 3;
   */
  nearestCompatible: boolean;
};
