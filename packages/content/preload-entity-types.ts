...
export const PRELOAD_ENTITY_TYPES = ["theta","planet_blue","star_yellow","minerals","collector_solar","worker","habitat","processor","factory","scout","raider","defense_pylon_v2","defense_pylon","collector_solar_v2","defense_pylon_v3","fighter_v1","heavy_fighter","battleship","science_vessel","scout_long_range"] as const;
